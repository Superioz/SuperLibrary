...
public class GameProfileBuilder {
    ...
    private static final String SERVICE_URL = "https://sessionserver.mojang.com/session/bukkit/profile/%s?unsigned=false";
    ...
    private static class GameProfileSerializer implements JsonSerializer<GameProfile>, JsonDeserializer<GameProfile> {
        ...
        /**
         * Deserialise the objects to a gameprofile
         *
